...
return (new CustomEvent(event_name,(function (){var obj30211 = {"detail":data};
return obj30211;
})()));
} else {
...
var f = (function (){var pred__30218 = cljs.core._EQ_;
var expr__30219 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30218.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30219))){
return ((function (pred__30218,expr__30219){
return (function (p1__30212_SHARP_){
return console.warn(p1__30212_SHARP_);
});
;})(pred__30218,expr__30219))
} else {
if(cljs.core.truth_(pred__30218.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30219))){
return ((function (pred__30218,expr__30219){
return (function (p1__30213_SHARP_){
return console.debug(p1__30213_SHARP_);
});
;})(pred__30218,expr__30219))
} else {
if(cljs.core.truth_(pred__30218.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30219))){
return ((function (pred__30218,expr__30219){
return (function (p1__30214_SHARP_){
return console.error(p1__30214_SHARP_);
});
;})(pred__30218,expr__30219))
} else {
return ((function (pred__30218,expr__30219){
return (function (p1__30215_SHARP_){
return console.log(p1__30215_SHARP_);
});
;})(pred__30218,expr__30219))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30222){
...
var eval_fn = cljs.core.get.call(null,map__30223__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30225_SHARP_);
});})(new_def))
);
...
return (function (p__30226){
var vec__30227 = p__30226;
var ky = cljs.core.nth.call(null,vec__30227,(0),null);
var v = cljs.core.nth.call(null,vec__30227,(1),null);
...
if(cljs.core.truth_((function (){var and__3911__auto__ = typeof localStorage !== 'undefined';
...
}catch (e30232){if((e30232 instanceof Error)){
var e = e30232;
return not_found;
} else {
throw e30232;
...
//# sourceMappingURL=utils.js.map?rel=1547484323293
