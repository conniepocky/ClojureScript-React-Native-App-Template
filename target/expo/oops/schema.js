...
var G__25738 = cljs.core.first.call(null,element_str);
switch (G__25738) {
case "?":
arr.push((1));
...
var G__25740 = cljs.core.next.call(null,items);
items = G__25740;
continue;
} else {
return null;
...
var G__25741 = cljs.core.next.call(null,items);
items = G__25741;
continue;
} else {
return null;
...
var G__25743 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__25743;
continue;
} else {
return true;
...
switch (G__25746) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__25746){
return (function (p1__25744_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25744_SHARP_,(2));
});})(G__25746))
))){
...
return cljs.core.not_EQ_.call(null,p1__25745_SHARP_,(1));
});})(G__25746))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25746)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1547484320304
