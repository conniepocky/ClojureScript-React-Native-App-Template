...
var vec__24974_24977 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_24978 = cljs.core.nth.call(null,vec__24974_24977,(0),null);
var only_after_24979 = cljs.core.nth.call(null,vec__24974_24977,(1),null);
var db_changed_QMARK__24980 = ((!((only_before_24978 == null))) || (!((only_after_24979 == null))));
if(db_changed_QMARK__24980){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_24978);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_24979);
...
var map__24981 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__24981__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__24981__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__24983 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__24983__$1;
var event = cljs.core.get.call(null,map__24983__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
/** @this {Function} */
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq24985){
...
return cljs.core.get_in.call(null,new_db,p1__24989_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__24990_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__24990_SHARP_);
...
/** @this {Function} */
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq24991){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24992,G__24993,seq24991__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1547484319539
