...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__23497 = cljs.core.instance_QMARK_;
var expr__23498 = reactive_val;
if(cljs.core.truth_(pred__23497.call(null,reagent.ratom.RAtom,expr__23498))){
return "ra";
} else {
if(cljs.core.truth_(pred__23497.call(null,reagent.ratom.RCursor,expr__23498))){
return "rc";
} else {
if(cljs.core.truth_(pred__23497.call(null,reagent.ratom.Reaction,expr__23498))){
return "rx";
} else {
if(cljs.core.truth_(pred__23497.call(null,reagent.ratom.Track,expr__23498))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1547484317360
